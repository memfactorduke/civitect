...
|---|---|---|---|---|---|---|---|
| 1 | Terrain section codec (RLE over u16 layers: elevation terrace, water, resource, zone, district) + map file = .civ container with TERRAIN only (`encodeMap`/`decodeMap`); map fixture seeded | protocol | TDD §5/§10 | M | RLE + map round-trip property tests; fixture decode pin | — | approved |
