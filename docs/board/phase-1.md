...
| 5 | Road command vocabulary: buildRoad / bulldozeRoad / upgradeRoad / undo / redo + new rejection reasons; PROTOCOL_VERSION bump + wire pins | protocol | TDD §7 | S–M | symmetric codec property + fixed-vector pins | — | in-review |
