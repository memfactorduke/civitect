...
| 6 | Map generator v1: seeded terrace/water/resource generation (integer noise, reproducible), 6 archetype maps committed as fixtures + preview PNGs via intake encoder | tools | TDD §13, GDD §3 | L | committed maps content-equal on regeneration; archetype sanity suite; previews committed | 1 | in-review |
