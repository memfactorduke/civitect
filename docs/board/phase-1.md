...
| 4 | ALT pathfinding (A* + landmark lower bounds) over the road graph + cache keyed by edge version with invalidation tests | sim | TDD §5 | M | equality-vs-Dijkstra-oracle property on random graphs; cache invalidation units; det-lint green | 3 | in-review |
