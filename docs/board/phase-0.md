...
| 8 | `.civ` save codec: header (magic/formatVersion/simVersion/seed/tick/checksums), sectioned layout, deflate-raw; fixture-save archive seeded | protocol | TDD §10, ADR-010 | M | round-trip property test + fixture round-trip | 2 | in-review |
