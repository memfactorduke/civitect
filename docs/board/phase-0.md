...
| 7 | App round trip: sim worker boot, command queue, transferable snapshots; tap→command→sim→snapshot→highlight | app | TDD §1/§7 | M | Playwright smoke asserting <50 ms input→visual (exit criterion 2) | 3, 5, 6 | in-review |
