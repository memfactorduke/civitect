...
| 5 | Renderer shell: Pixi v8 boot (WebGL), snapshot consumption, empty-world stage, tile highlight | renderer | TDD §8, ADR-008 | S–M | snapshot→display-state units; dev-server boot | 2 | in-review |
