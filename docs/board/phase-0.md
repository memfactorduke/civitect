...
| 6 | UI shell: React 19 overlay, zustand stores from snapshot scalars, command dispatch, i18n key plumbing | ui | TDD §9, ADR-009 | S | RTL component tests | 2 | in-review |
