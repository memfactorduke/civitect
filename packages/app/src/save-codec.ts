...
export function worldToCiv(world: World, commandTail: CivSave["commandTail"]): CivSave {
  ...
  return {
    ...
    economy: {
      taxRatesPermille: Uint16Array.from(world.economy.taxRatesPermille),
      loans: world.economy.loans.map((l) => ({ ...l })),
      monthAccumCents: [...world.economy.monthAccumCents],
      lastMonthCents: [...world.economy.lastMonthCents],
      milestoneIndex: world.economy.milestoneIndex,
      achievements: Uint8Array.from(world.economy.achievements),
      uniquesMask: world.economy.uniquesMask,
      difficulty: world.economy.difficulty,
    ...
    transit: {
      lines: world.transit.lines.map((l) => ({
        id: l.id,
        mode: l.mode,
        color: l.color,
        name: l.name,
        stops: Uint32Array.from(l.stops),
        vehicles: l.vehicles,
        headwayTicks: l.headwayTicks,
        riders: l.riders,
        costCents: l.costCents,
        fareCents: l.fareCents,
      })),
      nextLineId: world.transit.nextLineId,
    },
...
export function civToWorld(save: CivSave): World {
  ...
  const world: World = {
    ...
    economy: {
      taxRatesPermille: Uint16Array.from(save.economy.taxRatesPermille),
      loans: save.economy.loans.map((l) => ({ ...l })),
      monthAccumCents: [...save.economy.monthAccumCents],
      lastMonthCents: [...save.economy.lastMonthCents],
      milestoneIndex: save.economy.milestoneIndex,
      achievements: Uint8Array.from(save.economy.achievements),
      uniquesMask: save.economy.uniquesMask,
    ...
    transit: {
      lines: save.transit.lines.map((l) => ({
        id: l.id,
        mode: l.mode,
        color: l.color,
        name: l.name,
        stops: Array.from(l.stops),
        vehicles: l.vehicles,
        headwayTicks: l.headwayTicks,
        riders: l.riders,
        costCents: l.costCents,
      ...
      nextLineId: save.transit.nextLineId,
    },
    pendingReport: null,
